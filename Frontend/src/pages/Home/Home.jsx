      ...
      <main>
         <section className="banner">
            <article className="banner__content">
               <h1 className="banner__subtitle">Promoted Content</h1>
               <br></br>
         ...
         <section className="feature">
            <div className="feature__item">
               ...
               <p className="feature__item-text">Need to talk to a representative? You can get
               in touch through our 24/7 chat or through a phone call in less than 5 minutes.</p>
            </div>
            ...
            <div className="feature__item">
               ...
               <p className="feature__item-text">The more you save with us,
               the higher your interest rate will be!</p>
            </div>

            <div className="feature__item">
               <img src={iconSecurity} alt="Chat Icon" className="feature__icon"/>
               <h2 className="feature__item-title">Security you can trust</h2>
               <p className="feature__item-text">We use top of the line encryption to make sure
